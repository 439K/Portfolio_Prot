...
footerSongTitleElement.textContent = '楽曲未選択';
songArtistElement.textContent = '選択してください';
...
document.querySelectorAll('.music-item').forEach(item => {
    ...
    button.addEventListener('click', function () {
        ...
        const composerName = item.closest('.profile-item').querySelector('.artist_title').textContent;
